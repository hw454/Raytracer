...
<<<<<<< HEAD
     ...
     mp.grid()
     mp.savefig('../../ImagesOfSignalStrength/FiguresNew/Cumsum'+str(i)+'.jpg', bbox_inches='tight')
     mp.figure(i+1)
     mp.hist(z.flatten(),bins='auto')
     #mp.plot(h[1][:-1],h[0]) Plots the histogram as a line
     #mp.title('Histrogram of signal power')
     mp.grid()
     mp.savefig('../../ImagesOfSignalStrength/FiguresNew/HistogramNoBounds'+str(i)+'.jpg',bbox_inches='tight')
=======
     mp.figure(i+1)
     mp.hist(z.flatten(),bins='auto')
     #mp.plot(h[1][:-1],h[0]) Plots the histogram as a line
...
<<<<<<< HEAD
     #mp.title('Cumulative Frequency of signal power')
     mp.grid()
     mp.savefig('../../ImagesOfSignalStrength/FiguresNew/CumsumBounded'+str(i)+'.jpg',bbox_inches='tight')
     mp.figure(i+1)
     mp.hist(z.flatten(),bins='auto')
     #mp.plot(h[1][:-1],h[0]) Plots the histogram as a line
     #mp.title('Histrogram of signal power')
     mp.grid()
     mp.savefig('../../ImagesOfSignalStrength/FiguresNew/HistogramBounds'+str(i)+'.jpg',bbox_inches='tight')
=======
     mp.figure(i+1)
     mp.hist(z.flatten(),bins='auto')
     #mp.plot(h[1][:-1],h[0]) Plots the histogram as a line
