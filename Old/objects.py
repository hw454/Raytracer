...
<<<<<<< HEAD
    mp.plot(origin[0],origin[1],marker='x')
=======
...
<<<<<<< HEAD
  def uniform_ray_tracer(s,origin,n,i,spacing,frequency,start,m):
=======
...
>>>>>>> 0bf629148e179f8c20b2e0543a522c4ba18303f5
    for j in range(0,n+1):
      ...
      mp.figure(i+1)
<<<<<<< HEAD
      Mesh=ray.heatmapray(Mesh,ray.streg,ray.frequency,spacing)
    mp.figure(i)
    #mp.title('Ray paths')
    s.Plotroom(origin)
    mp.savefig('../../ImagesOfSignalStrength/FiguresNew/Rays'+str(i)+'.jpg',bbox_inches='tight')
    mp.figure(i+1)
    #mp.title('Heatmap')
    s.Plotroom(origin)
    mp.savefig('../../ImagesOfSignalStrength/FiguresNew/Heatmap'+str(i)+'.jpg',bbox_inches='tight')
    Mesh.hist(i+2)
    mp.figure(i+4)
    s.Plotroom(origin)
    mp.savefig('../../ImagesOfSignalStrength/FiguresNew/Room.jpg',bbox_inches='tight')
    return
  def uniform_ray_tracer_bounded(s,origin,n,i,spacing,frequency,start,m,bounds):
    ''' Traces ray's uniforming emitted from an origin around a room.
    Number of rays is n, number of reflections m'''
    pi=4*np.arctan(1) # numerically calculate pi
    Mesh=s.roommesh(spacing)
...
<<<<<<< HEAD
      ...
      ray.Plotray(s)
      mp.figure(i+1)
      Mesh=ray.heatmapraybounded(Mesh,ray.streg,ray.frequency,spacing,bounds)
    #mp.figure(i)
    #mp.title('Ray paths')
    ...
    mp.savefig('../../ImagesOfSignalStrength/FiguresNew/HeatmapBounded'+str(i)+'.jpg',bbox_inches='tight')
    s.Plotroom(origin)
...
class Ray:
  ...
  def raytest(s,room,err):
    ...
    return err
<<<<<<< HEAD
  def heatmapray(s,Mesh,streg,freq,spacing):
    i=0
=======
...
<<<<<<< HEAD
    ...
    Mesh.plot()
    return Mesh
  def heatmapraybounded(s,Mesh,streg,freq,spacing,bounds):
    i=0
=======
      #refloss=2
