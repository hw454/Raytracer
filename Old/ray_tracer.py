...
<<<<<<< HEAD
  n=1000                    # number of rays emitted from source
  ...
  bounds= np.array([10**-12, 10**3])               # The bounds within which the signal power is useful
=======
...
<<<<<<< HEAD
  Room.uniform_ray_tracer(origin,n,i,spacing,frequency,streg,m)
  Room.uniform_ray_tracer_bounded(origin,n,6,spacing,frequency,streg,m,bounds)
  origin=(0,2)              # source of the signal
  Room.uniform_ray_tracer(origin,n,11,spacing,frequency,streg,m)
  Room.uniform_ray_tracer_bounded(origin,n,17,spacing,frequency,streg,m,bounds)
=======
  for j in range(1,2):
      n=j*100
      print(n)
