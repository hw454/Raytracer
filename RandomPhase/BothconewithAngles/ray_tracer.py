...
if __name__=='__main__':
  ...
  l=10                        # number of n's
  n=100                      # Initial number of rays will be 2*n
  ...
  for j in range(1,l):
      ...
      #f.write("Estimated P value" % y)
  mp.figure(i+2)
  mp.plot(thetaNa[:][0],thetaNa[:][1])
  mp.title('Log Field_(0,0) approximated by n rays minus field_(0,0) approx by 2n rays plotted against n')
  mp.savefig('thetaNagainstNloc1.png')
  mp.figure(i+3)
  mp.plot(thetaNa[:][0],thetaNa[:][1])
  mp.title('Log Field_(0,0) approximated by n rays minus field_(0,0) approx by 2n rays plotted against n')
  mp.savefig('thetaNagainstNloc2.png')
  #mp.show()
