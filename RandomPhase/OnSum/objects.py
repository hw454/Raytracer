...
class room:
  ...
  def uniform_ray_tracer(s,origin,n,i,spacing,frequency,start,m,refloss):
    ...
    #mp.title('Ray paths')
    s.Plotroom(origin)
    mp.savefig('../../../../ImagesOfSignalStrength/FiguresNew/RandomPhase/OnSumRays'+str(i)+'.png',bbox_inches='tight')
    mp.figure(i+1)
    #mp.title('Heatmap')
    s.Plotroom(origin)
    ...
    mp.figure(i+4)
    s.Plotroom(origin)
    mp.savefig('../../../../ImagesOfSignalStrength/FiguresNew/RandomPhase/OnSumRoom.png',bbox_inches='tight')
    return
  def uniform_ray_tracer_bounded(s,origin,n,i,spacing,frequency,start,m,bounds,refloss):
    ...
    #mp.figure(i)
    #mp.title('Ray paths')
    #mp.savefig('../../../../ImagesOfSignalStrength/FiguresNew/RandomPhase/OnSumRays.png',bbox_inches='tight')
    #mp.figure(i+3)
    #s.Plotrom(origin)
    #mp.savefig('../../../../ImagesOfSignalStrength/FiguresNew/RandomPhase/OnSumtemproom.png',bbox_inches='tight')#This section is the same as the unbounded
    #s.Plotroom(origin)
    mp.figure(i+1)
    mp.title('Heatmap Bounded')
    mp.savefig('../../../../ImagesOfSignalStrength/FiguresNew/RandomPhase/OnSumHeatmapBounded'+str(i)+'.png',bbox_inches='tight')
    s.Plotroom(origin)
